...
## Work in Progress
This project is a work in progress and will keep evolving over time (whenever I feel like it). Features are being added and tweaked on the fly, with the main focus right now on getting the client launcher working

# Why it was made

This launcher was inspired by MilkLauncher, a Python-based tool created for launching Wizard101 & Pirate101. While MilkLauncher was a great tool, it didn’t fully meet the needs of my group—between me and a few others, we manage over 15 accounts, and flexibility became essential.

I needed a solution that allowed precise control, launching only the accounts I needed at any given time. I don’t expect many people—if anyone—to use this, but it exists for those rare edge ca

# Top Section
This is used for single use logins, you put your 
